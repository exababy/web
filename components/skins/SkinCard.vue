<template>
  ...
  >
    <div class="skin-card__body">
      ...
      <img :src="image" :alt="name" loading="lazy" class="skin-card__img" />
      <img
        v-if="bgColor"
    ...
    <div class="skin-card__footer">
      <div class="skin-card__info">
        <div class="skin-card__subtitle">{{ subtitle }}</div>
        <div class="skin-card__title">{{ name }}</div>
      </div>
    </div>
  </div>
</template>
